...
<head>
	...
	<script src="https://kit.fontawesome.com/bd48ac5ea9.js" crossorigin="anonymous"></script>
...
<div class="header">
	<div class="container">
		...
		<div class="logo"><img src="images/logo.jpg" width="125px" height="60px"></div>
			<nav>
				<ul>
					<li><a href="#">Home</a></li>
...
<div class="offer">
	...
	<div class="small-container">
		...
		<div class="row">
			...
			<div class="col-2">
				<img src="images/jeans.jpg" class="offer-img">
			</div>
			<div class="col-2">
				<p>Exclusively Available on RedStore</p>
				<h1>Smart Band 4</h1>
				<small>The Mi Smart Band 4 features a 39.9% larger (than Mi Band 3) Amoled color full-touch
				display with adjustable brightness, so everything is clear as can be.</small><br>
		...
		<div class="small-container">
			...
			<div class="row">
				...
				<div class="col-3">
					...
					<img src="images/user2.jpg" class="users">
					<h3>Eldridge Floro Francisco</h3>
				</div>
				...
				<div class="col-3">
					...
					<img src="images/user1.jpg" class="users">
					<h3>Cathy Rose Rosario</h3>
				</div>
